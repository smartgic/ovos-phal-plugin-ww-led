...
def get_version():
    ...
    version = None
    version_file = os.path.join(BASEDIR, "ovos_phal_plugin_ww_led", "version.py")
...
PLUGIN_ENTRY_POINT = "ovos-phal-plugin-ww-led=ovos_phal_plugin_ww_led:WwLedPlugin"
setup(
    name="ovos-phal-plugin-ww-led",
    version=get_version(),
    description="A plugin to turn a LED on when a wakeword is detected",
    long_description=get_description(),
    long_description_content_type="text/markdown",
    url="https://github.com/smartgic/ovos-phal-plugin-ww-led",
    author="Gaëtan Trellu (goldyfruit)",
    author_email="gaetan.trellu@gmail.com",
    license="Apache-2.0",
    packages=["ovos_phal_plugin_ww_led"],
    package_data={"": package_files("ovos_phal_plugin_ww_led")},
